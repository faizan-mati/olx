...
const Register = () => {
  ...
  const submit= async(name , email , password)=>{  
    ...
    const signupUserRes = await RegisterUser(name, email, password)
  ...
  const handleCancel = () => {
    setShowGmailOption(false);
  };

  return (
    <div className="center-container">
      <div className="gmail-option1 scrollable">
        <div className="gmail-option">
          ...
          <div className='registerPara'>
            <h1>REGISTER</h1>
            <p style={{ marginTop: "-5px", fontWeight: "500" }}>Effortlessly join our community by completing <br /> our user-friendly
              registration  process on our website</p>
          </div>

          <div className='formRegister'>
            <div>
              <label className='registerLabel'  htmlFor="name">Name</label> <br />
              <input className='registerInpur' type="text" id="name" name="name" placeholder='Name'
                required value={name}
                onChange={(e) => {
            ...
            <div style={{ paddingTop: "20px" }}>
              <label className='registerLabel'  htmlFor="name">Email</label> <br />
            ...
            <div style={{ paddingTop: "20px" }}>
              <label className='registerLabel'  htmlFor="name">Password</label> <br />
